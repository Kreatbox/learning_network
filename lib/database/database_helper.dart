    ...
    if (kIsWeb) {
      ...
      try {
        return await openDatabase(
          path,
          version: 1, // Ensure the version remains consistent
          onCreate: _onCreate,
        );
      } catch (e) {
        debugPrint("Error initializing database: $e");
        rethrow; // Optional: rethrow to handle it further up the call stack.
      }
    }
  }
...
''',
      'lesson_second_image': 'assets/images/lesson_7_second_image.jpg',
